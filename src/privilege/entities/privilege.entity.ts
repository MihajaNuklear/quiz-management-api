...
export enum PrivilegeName {
  ...
  VIEW_QUESTION = 'VIEW_QUESTION', // Consultation liste QUESTION
  CREATE_QUESTION = 'CREATE_QUESTION', // Création QUESTION
  EDIT_QUESTION = 'EDIT_QUESTION', // Modification QUESTION
  DELETE_QUESTION = 'DELETE_QUESTION', // Suppression QUIZ
